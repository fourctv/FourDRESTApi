# 4D RESTApi
A 4D V17.0 Component that provides a REST-like CRUD API for any 4D database.
...
This is a 4D V17.0 Component, so it must be installed on a 4D V17.0 compatible database structure.
