# 4D RESTApi
A 4D V17.4 Component that provides a REST-like CRUD API for any 4D database.

**This version has been modified to use Collections and ORDA as per 4D V17.0**

This component adds a couple of HTTP service entry points to your 4D application.

Of course you need to enable and activate 4D Web Server on your application.

This is a 4D V17.4 Component, so it must be installed on a 4D V17.4 compatible database structure.
...
* **[REST_BulkDelete](https://github.com/fourctv/FourDRESTApi/wiki/REST_BulkDelete)** - deletes a selection of records from the database that match a given query
* **[REST_BulkUpdate](https://github.com/fourctv/FourDRESTApi/wiki/REST_BulkUpdate)** - updates a list of records in the database
* **[REST_CountRecords](https://github.com/fourctv/FourDRESTApi/wiki/REST_Countrecords)** - returns the number of records  matching a given query
